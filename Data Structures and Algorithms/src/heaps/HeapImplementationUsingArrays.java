...
public class HeapImplementationUsingArrays {
	
	private int[] Heap;
    private int size;
    private int maxsize;

    public HeapImplementationUsingArrays(int size) {
        this.maxsize = size;
        this.size = 0;
...
public static void main(String[] args) {
	...
	HeapImplementationUsingArrays maxHeap = new HeapImplementationUsingArrays(15);
    maxHeap.insert(1);
    maxHeap.insert(4);
    maxHeap.insert(2);
    maxHeap.insert(5);
